...
/**
 * Truck Move - Top-down view camera moves laterally
 * Exact SVG and animation from classic.html
 */
export function TruckMove({ isHovered }) {
  ...
  return (
    <div 
      ...
      aria-label="Truck camera movement animation"
    >
